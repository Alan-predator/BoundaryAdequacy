...
# def save_boundary_pic_npy(load_path, save_path):
#     for i in range(10):
#         for j in range(10):
#             if j == i:
#                 continue
...
#                 arr_2 = temp_arr_2
#             else:
#                 arr_1 = np.concatenate((arr_1, temp_arr_1), axis=0)
#                 arr_2 = np.concatenate((arr_2, temp_arr_2), axis=0)
#         arr = np.concatenate((arr_1, arr_2), axis=0)
#         np.save(os.path.join(save_path, str(i) + '_boundary_img.npy'), arr)
...
if __name__ == '__main__':
    ...
    model = 'lenet1'
    # 1 pic2npy
    # load_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/dataset', dataset, 'picture', 'train')
    # save_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_1_save_pic_npy')
    # load_pic(load_path, dataset, save_path)

    # 2 gen adv pic
    load_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_1_save_pic_npy')
    save_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_2_get_adv_npy')
    gen_adv_pic(load_path, save_path, dataset, model)

    # 3-1 use origin dataset and adv dataset to find all boundary data
    # a_load_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_2_get_adv_npy')
    # b_load_path = os.path.join('/mnt/sda/project_flc/DeepBoundary', 'dataset', dataset, 'picture', 'train')
    # save_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_3_save_boundary_pic')
    ...
    # load_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_3_save_boundary_pic')
    # save_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_3_save_boundary_pic')
    # save_boundary_pic_npy(load_path, save_path, model)

    # 4 use test data generate test_adv_dataset with 4 attack
    # load_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/dataset', dataset, 'picture', 'test')
    # path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_4_save_pic_npy')
    #
    # if not os.path.exists(path):
    #     os.mkdir(path)
    # num = 800
    ...
    # rate = [0.3, 0.6, 0.9]
    # path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_4_save_pic_npy')
    # save_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_7_test')
    # if not os.path.exists(save_path):
    #     os.mkdir(save_path)
    ...
    # load_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_7_test')
    # save_path = os.path.join('/mnt/sda/project_flc/DeepBoundary/data', model, 'step_8_cal_edited_coverage')
    # if not os.path.exists(save_path):
    #     os.mkdir(save_path)
    # state = ['ori', 'fgsm', 'bim', 'jsma', 'cw']
    # rate = [0.3, 0.6, 0.9]
