...
if __name__ == '__main__':
    ...
    (train_datas, train_labels), (test_datas, test_labels) = keras.datasets.mnist.load_data("/mnt/sda/project_flc/DeepFeature/dataset/mnist/mnist.npz")
    ...
    path = '/mnt/sda/project_flc/DeepFeature/model/lenet1/lenet1.h5'
