...
if __name__ == '__main__':
    ...
    (train_datas, train_labels), (test_datas, test_labels) = keras.datasets.mnist.load_data("E:\pycharmproject\pythonProject\DeepBoundary\dataset\mnist\mnist.npz")
    ...
    path = 'E:\pycharmproject\pythonProject\DeepBoundary\model\lenet5\lenet5.h5'
